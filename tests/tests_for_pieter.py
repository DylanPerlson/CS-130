...
class Pieter(unittest.TestCase):
    ...
    def test_indirect_with_ranges(self):
        ...
        # wb.set_cell_contents(sh, 'A1', '=IFERROR(VLOOKUP(1, INDIRECT(B1 & "!A2:c4"), 2), "")') # TODO works but needs tests
        # wb.set_cell_contents(sh, 'A1', '=VLOOKUP(1, INDIRECT("sheet" & "!A2:c4"), 3)') # TODO works but needs tests
        # wb.set_cell_contents(sh, 'A1', '=VLOOKUP(1, INDIRECT(B1 & "!A2:c4"), 3)') # TODO works but needs tests
        # wb.set_cell_contents(sh, 'A1', '=VLOOKUP(1, sheet!A2:c4, 2)')
        # wb.set_cell_contents(sh, 'A1', '=INDIRECT(B1 & "!A2:c4")') # TODO works but needs tests
        # wb.set_cell_contents(sh, 'A1', '=SUM(INDIRECT(B1 & "!A2:c4"))') # TODO works but needs tests
        # wb.set_cell_contents(sh, 'A1', '=INDIRECT(B1)') # TODO works but needs tests
    ...
    def test_indirect_func(self):
        ...
        # wb.set_cell_contents(sh, 'A2', '123')
